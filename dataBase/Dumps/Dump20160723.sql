...
INSERT INTO `complejosdireccion` VALUES (1,'Mitre',750,55,1,-34.7772293,-58.3869362),(2,'Laprida',948,361,1,1.0000000,1.0000000),(3,'Larroque',756,55,1,1.0000000,1.0000000),(4,'Av H Yrigoyen',6637,339,1,1.0000000,1.0000000),(5,'Monteagudo',1317,55,1,1.0000000,1.0000000),(6,'Las Heras',646,55,1,1.0000000,1.0000000);
...
INSERT INTO `complejospagos` VALUES (1,'2147483647','4545454'),(6,'24412','555122');
...
INSERT INTO `devoluciones` VALUES (1,1,2,550.00,'2016-07-19',1),(2,1,2,550.00,'2016-07-19',1),(3,1,2,0.00,'2016-07-19',2),(4,1,3,445.00,'2016-06-01',2),(5,1,3,445.00,'2016-06-01',2),(6,1,3,500.00,'2016-06-10',2),(7,1,3,700.00,'2016-06-22',2);
...
BEGIN
    ...
    select com.HorasCancelacion, time_to_sec(timediff(CONCAT(res.fecha, ' ', res.HoraInicio), NOW() )) / 3600
...
-- Dump completed on 2016-07-23 16:29:22
