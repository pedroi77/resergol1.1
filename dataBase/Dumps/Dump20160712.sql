...
INSERT INTO `devoluciones` VALUES (1,5,2,550.00),(2,5,2,550.00);
...
INSERT INTO `equipos` VALUES (0,5,'',NULL),(1,2,'independiente',NULL),(2,5,'fluminense',NULL),(3,5,'river',NULL),(4,6,'racing',NULL),(5,7,'boca',NULL),(6,11,'San lorenzo',NULL),(7,12,'Banfield',NULL),(8,13,'arsenal',NULL),(9,14,'central',NULL),(10,15,'newlls',NULL),(11,16,'colon',NULL),(12,17,'talleres',NULL),(13,18,'instituto',NULL),(14,19,'lanus',NULL),(15,20,'godoy cruz',NULL),(16,21,'estudiantes',NULL),(17,22,'gimnasia',NULL),(18,23,'almagro',NULL),(19,24,'allboys',NULL),(20,25,'los andes',NULL),(21,26,'olimpo',NULL),(22,27,'aldosivi',NULL),(23,28,'defensa',NULL),(24,29,'chacarita',NULL),(25,30,'chicago',NULL),(26,31,'velez',NULL),(27,5,'berazategui',NULL),(28,5,'union',NULL),(29,5,'onceClub',NULL),(30,5,'belgrano',NULL),(31,5,'cruzero',NULL),(32,5,'santos',NULL),(33,2,'eq','http://localhost:8080/resergol1.1/api/Imagenes/equipos/TP_2016712_2221.jpg'),(34,2,'test!','');
...
INSERT INTO `torneoscanchas` VALUES (12,1,1),(12,1,2),(13,1,1),(13,1,2),(16,1,4),(16,1,5),(17,1,1),(17,1,2),(19,1,1),(19,1,2),(20,1,2),(20,1,5);
...
INSERT INTO `torneosequipos` VALUES (3,33,1,'2016-07-11'),(3,34,1,'2016-07-12'),(12,1,1,NULL),(12,2,1,NULL),(12,3,1,NULL),(12,4,1,NULL),(12,5,1,NULL),(12,6,1,NULL),(12,7,1,NULL),(12,8,1,NULL),(12,9,1,NULL),(12,10,1,NULL),(12,11,1,NULL),(12,12,1,NULL),(12,13,1,NULL),(12,14,1,NULL),(12,15,1,NULL),(12,16,1,NULL),(12,17,1,NULL),(12,18,1,NULL),(12,19,1,NULL),(12,20,1,NULL),(12,21,1,NULL),(12,22,1,NULL),(12,23,1,NULL),(12,25,1,NULL),(12,26,1,NULL),(12,27,1,NULL),(12,28,1,NULL),(12,29,1,NULL),(12,30,1,NULL),(12,31,1,NULL),(12,32,1,NULL),(13,1,1,'2016-06-12'),(13,2,1,'2016-06-12'),(13,3,1,'2016-06-12'),(13,4,1,'2016-06-12'),(13,5,1,'2016-06-12'),(13,6,1,'2016-06-12'),(13,7,1,'2016-06-12'),(13,8,1,'2016-06-12'),(16,1,1,'2016-07-09'),(16,2,1,'2016-07-09'),(16,3,1,'2016-07-09'),(16,4,1,'2016-07-09'),(16,5,1,'2016-07-09'),(16,6,1,'2016-07-09'),(16,7,1,'2016-07-09'),(16,8,1,'2016-07-09'),(16,9,1,'2016-07-09'),(16,10,1,'2016-07-09'),(16,11,1,'2016-07-09'),(16,12,1,'2016-07-09'),(16,13,1,'2016-07-09'),(16,14,1,'2016-07-09'),(16,15,1,'2016-07-09'),(16,16,1,'2016-07-09'),(17,1,1,'2016-07-09'),(17,2,1,'2016-07-09'),(17,3,1,'2016-07-09'),(17,4,1,'2016-07-09'),(19,1,1,'2016-07-09'),(19,2,1,'2016-07-09'),(19,3,1,'2016-07-09'),(19,4,1,'2016-07-09'),(19,5,1,'2016-07-09'),(19,6,1,'2016-07-09'),(19,7,1,'2016-07-09'),(19,8,1,'2016-07-09'),(20,2,1,'2016-07-10'),(20,3,1,'2016-07-10'),(20,4,1,'2016-07-10'),(20,5,1,'2016-07-10'),(20,6,1,'2016-07-10');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_deleteEquipoTorneo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_deleteEquipoTorneo`(IN `pIdTorneo` INT(11), IN `pIdEquipo` INT(11), OUT `valor` INT)
    NO SQL
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_getTorneosByCliente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_getTorneosByCliente`(IN `pIdCliente` INT(11), IN `pTodos` INT, IN `pInscripcion` INT, IN `pActivos` INT, IN `pFinalizados` INT)
BEGIN

IF (pTodos = 1) THEN


select DISTINCT t.IdTorneo, tt.IdTipoTorneo, t.Nombre, tes.IdEstado, tes.Descripcion as Estado, tt.Nombre as TipoTorneo, t.CantEquipos, com.IdComplejo, com.Nombre as Complejo,
t.FechaInicio, DATE_FORMAT(t.FechaInicio,'%d-%m-%Y') as FechaInicioFormateada, t.FechaFin, t.PrecioInscripcion,
DATE_FORMAT(t.FechaFin,'%d-%m-%Y') as FechaFinFormateada, eq.Nombre as Equipo, eq.IdEquipo, te.fechaInscipcion,
DATE_FORMAT(te.fechaInscipcion,'%d-%m-%Y') as FechaInscripcionFormateada,
cd.Calle, cd.Altura, l.Nombre as Localidad, p.Nombre as Provincia, t.HorasCancelacion, 
date_sub(t.FechaInicio, INTERVAL + t.HorasCancelacion HOUR) as CancelacionHasta
from torneos t
inner join torneosequipos te on te.IdTorneo = t.IdTorneo
inner join equipos eq on eq.IdEquipo = te.IdEquipo
inner join clientes c on c.IdCliente = eq.IdCliente
inner join complejos com on com.IdDuenio = t.IdDuenio
inner join complejosdireccion cd on cd.IdComplejo = com.IdComplejo
inner join localidades l on l.IdProvincia = cd.IdProvincia and l.IdLocalidad = cd.IdLocalidad
inner join provincias p on p.IdProvincia = cd.IdProvincia
inner join tipotorneos tt on tt.IdTipoTorneo = t.IdTipoTorneo
inner join torneosestados tes on tes.IdEstado = t.IdEstado
where c.IdCliente = pIdCliente
order by te.fechaInscipcion;

ELSE

select DISTINCT t.IdTorneo, tt.IdTipoTorneo, t.Nombre, tes.IdEstado, tes.Descripcion as Estado, tt.Nombre as TipoTorneo, t.CantEquipos, com.IdComplejo, com.Nombre as Complejo,
t.FechaInicio, DATE_FORMAT(t.FechaInicio,'%d-%m-%Y') as FechaInicioFormateada, t.FechaFin, t.PrecioInscripcion,
DATE_FORMAT(t.FechaFin,'%d-%m-%Y') as FechaFinFormateada, eq.IdEquipo, eq.Nombre as Equipo, te.fechaInscipcion,
DATE_FORMAT(te.fechaInscipcion,'%d-%m-%Y') as FechaInscripcionFormateada,
cd.Calle, cd.Altura, l.Nombre as Localidad, p.Nombre as Provincia, t.HorasCancelacion, 
date_sub(t.FechaInicio, INTERVAL + t.HorasCancelacion HOUR) as CancelacionHasta
from torneos t
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_insertEquipo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_insertEquipo`(IN `pIdCliente` INT(11), IN `pNombre` VARCHAR(100), IN `pUrl` VARCHAR(150), OUT `pResultado` INT)
    NO SQL
BEGIN
	...
	SET pResultado = (SELECT MAX(IdEquipo) from equipos);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_insertEquipoEnTorneo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_insertEquipoEnTorneo`(IN `pIdTorneo` INT(11), IN `pIdEquipo` INT(11), OUT `pResultado` INT)
BEGIN
...
-- Dump completed on 2016-07-12  0:07:05
