...
INSERT INTO `canchaspuntuacion` VALUES (1,5,12,11,4,'2016-05-26 00:00:00'),(2,5,12,20,2,'2016-05-26 00:00:00'),(3,5,12,21,5,'2016-05-26 00:00:00'),(4,3,8,14,5,'2016-05-26 00:00:00'),(5,5,11,14,1,'2016-05-26 00:00:00'),(6,3,8,7,2,'2016-05-28 00:00:00'),(7,5,11,7,2,'2016-05-28 00:00:00'),(8,6,16,2,2,'2016-07-02 00:26:51'),(9,5,12,2,1,'2016-07-01 22:31:39'),(10,6,16,33,4,'2016-07-02 00:26:05'),(11,2,6,2,2,'2016-07-02 00:31:42'),(12,3,8,2,3,'2016-07-03 13:53:30'),(13,3,8,33,5,'2016-07-02 15:25:37');
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_getPuntuacionCancha`(IN `pIdCancha` INT(11), IN `pIdComplejo` INT(11))
BEGIN
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_getReservasByCliente`(IN `pIdCliente` INT(11))
BEGIN
...
(r.APagar - r.Pagado) as Restante, DATE_ADD(r.FechaReserva, INTERVAL c.HorasCancelacion HOUR) as CancelacionHasta
from reservas r
...
order by r.FechaReserva, r.Fecha desc;
...
-- Dump completed on 2016-07-03 15:14:46
