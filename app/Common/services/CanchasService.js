...
app.service("CanchasService", function($http, $resource){
    ...
    var CANCHAS_URI = "http://localhost:8080/resergol1.1/api/canchas/:idDuenio/:idCancha/:idComplejo/:pIdProv/:pIdLoc/:pCantJug/:pIdSuperficie/:pPrecioMax/:pTechada/:pConLuz/:pConEstac/:pConDuchas/:pConBuffet/:pConParrilla/:pConWifi";
