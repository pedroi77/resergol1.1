    ...
    <div class="container" ng-controller="BuscarCanchasController as bus">
        <div class ="principal row">
           ...
           <div class="col-md-6">
                        ...
                        <form id="user-form" class="form-horizontal form-label-left">
                            <fieldset>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <!--<select id="jugadores" required="required"
                                            class=" form-control" 
                                            name="jugadores" style="margin-bottom:5px;">
                               ...
                               <div class="col-sm-4">    
                                    <p class="input-group">
                                                      <input type="text" id="fecha" class="form-control" uib-datepicker-popup="{{format}}" ng-model="dt" is-open="popup1.opened" datepicker-options="dateOptions" ng-required="true" close-text="Cerrar" alt-input-formats="altInputFormats" />
                                ...
                                <div class="col-sm-4" >    
                                    <select  id="superficie" required="required"
                                            data-placeholder="Seleccione una localidad" 
                                            class="select2 form-control" 
                                            name="localidades" style="margin-bottom:5px;">
                                        <option value="1" selected="selected">18 Hs</option>
                                        <OPTION>18 Hs</OPTION> 
                                        <OPTION>19 Hs</OPTION> 
                                        <OPTION>19 Hs</OPTION> 
                                        <OPTION>20 Hs</OPTION> 
                            ...
                            <label for="precio" class="control-label col-sm-3 ">Precio máximo</label>
                                <div class="col-sm-3">       
                                    <input   type="number" id="precioMaximo" class="input-sm col-sm-3 form-control">
                                </div>
            ...
            <div class="col-md-6">
                    <div class="col-md-6 carousel-container anchoCarousel ">
                        <div id="carouselComplejos" class="carousel slide carousel-fade">
                            <!-- Carousel items -->
                            <div class="carousel-inner carousel-altoBusqueda">
                                <div data-slide-no="0" class="item carousel-item active">
                                    <img src="/../resergol1.1/images/complejos/complejo1.jpeg" alt="">
                                    <div class="carousel-caption">
                                    </div>
                                </div>
                                <div data-slide-no="1" class="item carousel-item">
                                    <img src="/../resergol1.1/images/complejos/complejo2.jpg" alt="">
                                    <div class="carousel-caption">
                                    </div>
                                </div>
                                <div data-slide-no="2" class="item carousel-item">
                                    <img src="/../resergol1.1/images/complejos/complejo3.jpg" alt="">
                                    <div class="carousel-caption">
                                    </div>
                                </div>
                            </div>
                            <!-- Carousel nav -->
                            <a class="carousel-control left" href="#carouselComplejos" data-slide="prev">‹</a>
                            <a class="carousel-control right" href="#carouselComplejos" data-slide="next">›</a>
                        </div>
            ...
            <div style="color:white;" ng-show="canchas.length > 0">
            ...
            <div style="color:#FFE6E6;" ng-show="canchas.length == 0 && bus.seBusco">
						...
						<div class="caption">
							...
							<div class="caption-text">
								<h3 style="border-top:2px solid white; border-bottom:2px solid white; padding:1px;">                       {{cancha.NombreCancha}}
                                    <button class="btn-xs btn-primary" id="cuatro">"Muy buena!"</button>
                                </h3>
								...
								<ul>
                                    ...
                                    <li>Precio p/Hora: ${{cancha.Precio}} </li>
                                </ul>
                                <div class="col-md-12 text-center">
								<a href="#" class="btn btn-success" ui-sref="Clientes.verCancha({id:'{{cancha.IdCancha}}'})" onclick="$('html,body').animate({scrollTop:0},'fast');return false;"><span class="glyphicon glyphicon-eye-open"></span> VER CANCHA</a>
                                </div>
							</div>
						</div>
					</div>
      ...
      <div class="text-center" id="divpag">        
        ...
        <div class="col-sm-2">
        <button id="btnSubir" class="btn btn-md btn-primary btn-block" onclick="$('html,body').animate({scrollTop:10},'slow');return false;" ng-show = "canchas.length > 0"><i class="fa fa-plus glyphicon glyphicon-arrow-up"></i> Subir</button>
      </div>     
</div>     
